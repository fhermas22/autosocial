<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div class="flex items-center space-x-6">
            <div class="relative w-24 h-24">
                <img src="{{ Auth::user()->avatar
                    ...
                    alt="Avatar actuel"
                    class="w-full h-full rounded-full object-cover border-4 border-autosocial-primary shadow-lg">
            </div>

            <div>
                <x-input-label for="avatar" :value="__('Changer de Photo de Profil')" />
                ...
                <p class="text-xs text-gray-500 mt-1">Fichier JPG ou PNG (max 1MB).</p>
            </div>
        </div>
        ...
        <div class="flex items-center gap-4">
            <x-primary-button>{{ __('Sauvegarder les changements') }}</x-primary-button>
